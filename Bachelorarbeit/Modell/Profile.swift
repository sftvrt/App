...
struct Profile:Codable {
  ...
  //  static let `default` = Self(username: randomUserName, Geschlecht: .weiblich, Alter: "Ihr Alter", regionaleHerkunft: "Ihre Herkunft",timeInfo: [:])
    static let `default` = Self(username: randomUserName, Geschlecht: " ", Alter: " ", regionaleHerkunft: "",timeInfo: [:])
  ...
  */
  init(username: String, Geschlecht: String, Alter: String, regionaleHerkunft: String,userLatitude: String = "",userLongitude: String = "",userCity: String = "",userCountry: String = "",timeInfo:[String:String] = [:]) {
