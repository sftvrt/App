...
class NearbyService: NSObject,ObservableObject{
    ...
    var leader: MCPeerID?
    let peerID: MCPeerID
    var connectedNames: [MCPeerID] = []
    var connectHistoryNames: Set<MCPeerID> = []
...
extension NearbyService: MCSessionDelegate{
    func session(_ session: MCSession, peer peerID: MCPeerID, didChange state: MCSessionState) {
        self.connectedNames = session.connectedPeers
        
        self.connectHistoryNames.update(with: peerID)
...
//            self.connectedNames = session.connectedPeers
//            self.connectHistoryNames += session.connectedPeers
//            let arrayWithSet = Set(self.connectHistoryNames)
//            self.connectHistoryNames = Array(arrayWithSet)
//       }
    }
